...
$query = "SELECT username FROM `registration` WHERE id='$val'";
$row=  mysqli_query($dbc, $query);
$r = mysqli_fetch_array($row, MYSQLI_BOTH);
$uname = $r['username'];

$query = "SELECT * FROM `comment` WHERE username='$uname' ORDER BY time DESC";
